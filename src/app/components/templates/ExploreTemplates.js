...
const ExploreTemplates = () => {
    ...
    const TemplateThumbnail = dynamic(() => import("@/app/components/templates/TemplateThumbnail"))
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
                        {topTemplates ? (
                            topTemplates.map((template, index) => {
                                return (
                                    <div key={index} className='rounded bg-gray-100 dark:bg-gray-700 p-2 flex flex-col items-center justify-center gap-1'>
