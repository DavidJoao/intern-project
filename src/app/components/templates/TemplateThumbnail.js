...
const TemplateThumbnail = ({ template, index }) => {
  ...
  return (
    <Tooltip text={template.description}>
        <div className='rounded p-3 flex flex-col items-center justify-center cursor-pointer dark:bg-gray-900 dark:hover:bg-gray-800 bg-slate-200 hover:bg-slate-100 transition-all shadow-md w-full h-full' onClick={() => {
